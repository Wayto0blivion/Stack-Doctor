...
object StackDoctorColors {
    ...
    val NODE_FILL_TOP = JBColor.lazy { ColorUtil.brighter(nodeBackground(), 2) }
    val NODE_FILL_BOTTOM = JBColor.lazy { ColorUtil.darker(nodeBackground(), 1) }
    ...
    val WARNING_FILL_TOP = JBColor.lazy { tint(WARNING_TEXT, 0.08) }
    val WARNING_FILL_BOTTOM = JBColor.lazy { tint(WARNING_TEXT, 0.18) }
    val ERROR_FILL_TOP = JBColor.lazy { tint(ERROR_TEXT, 0.08) }
    val ERROR_FILL_BOTTOM = JBColor.lazy { tint(ERROR_TEXT, 0.18) }
    ...
    val ACCENT_DATABASE = JBColor.lazy { syntax(DefaultLanguageHighlighterColors.KEYWORD, JBColor(Color(0x8E5BD0), Color(0xB084E6))) }
    val ACCENT_CACHE = JBColor.lazy { syntax(DefaultLanguageHighlighterColors.NUMBER, JBColor(Color(0xD08A3E), Color(0xE3A862))) }
    val ACCENT_PROXY = JBColor.lazy { syntax(DefaultLanguageHighlighterColors.FUNCTION_DECLARATION, JBColor(Color(0x2B8A8A), Color(0x4FB6B6))) }
    val ACCENT_QUEUE = JBColor.lazy { syntax(DefaultLanguageHighlighterColors.STRING, JBColor(Color(0xC65B8A), Color(0xE085AC))) }
    val ACCENT_WEB = JBColor.lazy { syntax(DefaultLanguageHighlighterColors.INSTANCE_FIELD, JBColor(Color(0x3B82F6), Color(0x5B9BF7))) }
    ...
    private fun syntax(key: TextAttributesKey, fallback: JBColor): Color {
        ...
        // defaultAttributes is @NotNull on current platforms but was nullable on older releases we
        // still support (2025.3), so keep the null guard for runtime safety there.
        val default: TextAttributes? = key.defaultAttributes
